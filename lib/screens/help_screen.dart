...
class HelpScreen extends StatelessWidget {
  ...
  Widget _faqList() {
    final faqs = [
      ['ซื้อแล้วคอร์สอยู่ตรงไหน?', 'ไปที่แท็บ My Courses กดปุ่ม "เข้าเรียน" เพื่อเริ่มดูวิดีโอได้ทันที'],
      ['ดูได้กี่อุปกรณ์?', 'สามารถใช้งานได้บนมือถือและแท็บเล็ต ภายใต้บัญชีเดิม'],
      ...
      ['แบบทดสอบใช้งานอย่างไร?', 'เปิดหน้า My Courses เลือกคอร์ส แล้วไปที่แท็บ "แบบทดสอบ" เพื่อทำข้อสอบ ดูผลคะแนนได้ทันทีหลังส่ง'],
